...
class LessonController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $lesson = LessonResource::collection(Lesson::all($limit));
    ...
    public function show($id)
    {
        ...
        return $lesson->response()->setStatusCode(200, "User Returned Succefully")
    ...
    {
        $iduser = Lesson::findOrFail($id);
        $this->authorize('update', $iduser );
        $lesson = new LessonResource(Lesson::findOrFall($id));
